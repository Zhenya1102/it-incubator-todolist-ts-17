...
test("correct todolist should be added", () => {
  ...
  const endState = todolistsReducer(startState, addTodolist.fulfilled({ todolist }, "requestId", "todolist"));
...
test("todolists should be added", () => {
  const action = todosThunks.fetchTodolists.fulfilled({ todolists: startState }, "requestId");
