...
import { addTodolist, fetchTodolists, removeTodolist, todosThunks } from "features/TodolistsList/todolists-reducer";
...
test("new array should be added when new todolist is added", () => {
  ...
  const action = addTodolist.fulfilled(payload, "requreId", "new todolist");
